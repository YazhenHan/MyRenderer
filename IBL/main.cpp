...
int main()
{
    ...
    // marble
    unsigned int marbleAlbedoMap = loadTexture("resources/textures/pbr/marble/albedo.png");
    unsigned int marbleNormalMap = loadTexture("resources/textures/pbr/marble/normal.png");
    unsigned int marbleMetallicMap = loadTexture("resources/textures/pbr/marble/metallic.png");
    unsigned int marbleRoughnessMap = loadTexture("resources/textures/pbr/marble/roughness.png");
    unsigned int marbleAOMap = loadTexture("resources/textures/pbr/marble/ao.png");

    // gray_granite_flecks
    unsigned int graniteAlbedoMap = loadTexture("resources/textures/pbr/granite/albedo.png");
    unsigned int graniteNormalMap = loadTexture("resources/textures/pbr/granite/normal.png");
    unsigned int graniteMetallicMap = loadTexture("resources/textures/pbr/granite/metallic.png");
    unsigned int graniteRoughnessMap = loadTexture("resources/textures/pbr/granite/roughness.png");
    unsigned int graniteAOMap = loadTexture("resources/textures/pbr/granite/ao.png");

    // wood
    unsigned int woodAlbedoMap = loadTexture("resources/textures/pbr/wood/albedo.png");
    unsigned int woodNormalMap = loadTexture("resources/textures/pbr/wood/normal.png");
    unsigned int woodMetallicMap = loadTexture("resources/textures/pbr/wood/metallic.png");
    unsigned int woodRoughnessMap = loadTexture("resources/textures/pbr/wood/roughness.png");
    unsigned int woodAOMap = loadTexture("resources/textures/pbr/wood/ao.png");
    ...
    float roughness = 0.5, metallic = 0.5, ao = 0.5;
    bool wiremode = false;
    int material = 0;
    ImVec4 albedo = ImVec4(1.0f, 1.0f, 1.0f, 1.0f);
    float lightPower[3] = { 500.0f, 500.0f, 500.0f };
    float lightPosition[3] = { 0.0f, 0.0f, 10.0f };
    // render loop
    // -----------
    while (!glfwWindowShouldClose(window))
    {
        ...
        pbrShader.setBool("textmap", material > 0);
        ...
        case 5:
            ...
            break;
        default:
            pbrShader.setVec3("albedom", albedo.x, albedo.y, albedo.z);
            pbrShader.setFloat("metallicm", metallic);
            pbrShader.setFloat("roughnessm", roughness);
            pbrShader.setFloat("aom", ao);
            break;
        }
        renderSphere();

        pbrShader.setVec3("lightPosition", lightPosition[0], lightPosition[1], lightPosition[2]);
        pbrShader.setVec3("lightPower", lightPower[0], lightPower[1], lightPower[2]);
        ...
        {
            ImGui::Begin("setting");
            ImGui::Text(util::sctoc("fps: ", util::itoc(fps)));
            ImGui::ColorEdit3("albedo", (float*)&albedo);
            ImGui::SliderFloat3("light power", lightPower, 0.0, 1500.0);
            ImGui::SliderFloat3("light position", lightPosition, -25.0, 25.0);
            ImGui::SliderFloat("roughness", &roughness, 0.0f, 1.0f);
            ImGui::SliderFloat("metallic", &metallic, 0.0f, 1.0f);
            ImGui::SliderFloat("ao", &ao, 0.0f, 1.0f);
            ImGui::Checkbox("WireMode", &wiremode);
            ImGui::RadioButton("customize", &material, 0); ImGui::SameLine();
            ImGui::RadioButton("rusted iron", &material, 1); ImGui::SameLine();
            ImGui::RadioButton("gold", &material, 2);
            ImGui::RadioButton("marble", &material, 3); ImGui::SameLine();
            ImGui::RadioButton("granite", &material, 4); ImGui::SameLine();
            ImGui::RadioButton("wood", &material, 5);
            ImGui::End();
        }
        ImGui::Render();
